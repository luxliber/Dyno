...
namespace Dyno.Themes
{
    ...
    partial class WorkspaceFormWindowStyle
    {
        ...
        void OnSize(object sender, SizingAction action)
        {
            if (Mouse.LeftButton == MouseButtonState.Pressed)
            {
                sender.ForWindowFromTemplate(w =>
                {
                    ...
                    var workspaceFormWindow = w as Views.WorkspaceFormWindow;
                    if (workspaceFormWindow != null)
                        workspaceFormWindow.IsSizeChanged = true;
                });
            }
        }
