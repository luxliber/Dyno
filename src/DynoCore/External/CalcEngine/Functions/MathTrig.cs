...
namespace CalcEngine
{
    static class MathTrig
    {
        ...
        {
            ce.RegisterFunction("ABS", 1, Abs, "Math");
            ce.RegisterFunction("ACOS", 1, Acos, "Math");
            //Ce.RegisterFunction("ACOSH", Acosh, 1);
            ce.RegisterFunction("ASIN", 1, Asin, "Math");
            //Ce.RegisterFunction("ASINH", Asinh, 1);
            ce.RegisterFunction("ATAN", 1, Atan, "Math");
            ce.RegisterFunction("ATAN2", 2, Atan2, "Math");
            //Ce.RegisterFunction("ATANH", Atanh, 1);
            ce.RegisterFunction("ROUNDUP", 1, Ceiling, "Math");
            //Ce.RegisterFunction("COMBIN", Combin, 1);
            ce.RegisterFunction("COS", 1, Cos, "Math");
            //ce.RegisterFunction("COSH", 1, Cosh, "Math");
            //Ce.RegisterFunction("DEGREES", Degrees, 1);
            //Ce.RegisterFunction("EVEN", Even, 1);
            ce.RegisterFunction("EXP", 1, Exp, "Math");
            //Ce.RegisterFunction("FACT", Fact, 1);
            //Ce.RegisterFunction("FACTDOUBLE", FactDouble, 1);
            ce.RegisterFunction("ROUNDDOWN", 1, Floor, "Math");
            //Ce.RegisterFunction("GCD", Gcd, 1);
            ce.RegisterFunction("ROUND", 1, Int, "Math");
            //Ce.RegisterFunction("LCM", Lcm, 1);
            ce.RegisterFunction("LN", 1, Ln, "Math");
            //ce.RegisterFunction("LOG", 1, 2, Log, "Math");
            ce.RegisterFunction("LOG10", 1, Log10, "Math");
            ...
            ce.RegisterFunction("PI", 0, Pi, "Math");
            ce.RegisterFunction("POWER", 2, Power, "Math");
            //Ce.RegisterFunction("PRODUCT", Product, 1);
            //Ce.RegisterFunction("QUOTIENT", Quotient, 1);
            //Ce.RegisterFunction("RADIANS", Radians, 1);
            ce.RegisterFunction("RAND", 0, Rand, "Math");
            ce.RegisterFunction("RANDBETWEEN", 2, RandBetween, "Math");
            ...
            //ce.RegisterFunction("SIGN", 1, Sign, "Math");
            ce.RegisterFunction("SIN", 1, Sin, "Math");
            //ce.RegisterFunction("SINH", 1, Sinh, "Math");
            ce.RegisterFunction("SQRT", 1, Sqrt, "Math");
            //Ce.RegisterFunction("SQRTPI", SqrtPi, 1);
            //Ce.RegisterFunction("SUBTOTAL", Subtotal, 1);
            //ce.RegisterFunction("SUM", 1, int.MaxValue, Sum, "Math");
            //Ce.RegisterFunction("SUMIF", 2, 3, SumIf, "Math");
            ...
            ce.RegisterFunction("TAN", 1, Tan, "Math");
            //ce.RegisterFunction("TANH", 1, Tanh, "Math");
            //Ce.RegisterFunction("TRUNC", 1, Trunc, "Math");
        }
        ...
        static bool ValueSatisfiesCriteria(object value, object criteria, CalcEngine ce)
        {
            ...
            if (!string.IsNullOrEmpty(cs))
            {
                ...
                if (cs[0] == '=' || cs[0] == '<' || cs[0] == '>')
                {
                    ...
                    {
                        double d;
                        if (!double.TryParse(m.Groups[1].Value, NumberStyles.Float, NumberFormatInfo.InvariantInfo, out d) ||
                            !double.TryParse(m.Groups[3].Value, NumberStyles.Float, NumberFormatInfo.InvariantInfo, out d))
                        {
