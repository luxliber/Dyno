...
namespace CalcEngine
{
    static class Statistical
    {
        public static void Register(CalcEngine ce)
        {
            ...
            ce.RegisterFunction("AVERAGE", 1, int.MaxValue, Average, "Statistical");
            ce.RegisterFunction("AVERAGEA", 1, int.MaxValue, AverageA, "Statistical");
            ...
            ce.RegisterFunction("COUNT", 1, int.MaxValue, Count, "Statistical");
            ce.RegisterFunction("COUNTA", 1, int.MaxValue, CountA, "Statistical");
            ce.RegisterFunction("COUNTBLANK", 1, int.MaxValue, CountBlank, "Statistical");
            //Ce.RegisterFunction("COUNTIF", 2, CountIf, "Statistical");
            ...
            ce.RegisterFunction("MAX", 1, int.MaxValue, Max, "Statistical");
            ce.RegisterFunction("MAXA", 1, int.MaxValue, MaxA, "Statistical");
            //MEDIAN	Returns the median of the given numbers
            ce.RegisterFunction("MIN", 1, int.MaxValue, Min, "Statistical");
            ce.RegisterFunction("MINA", 1, int.MaxValue, MinA, "Statistical");
            ...
            ce.RegisterFunction("STDEV", 1, int.MaxValue, StDev, "Statistical");
            ce.RegisterFunction("STDEVA", 1, int.MaxValue, StDevA, "Statistical");
            ce.RegisterFunction("STDEVP", 1, int.MaxValue, StDevP, "Statistical");
            ce.RegisterFunction("STDEVPA", 1, int.MaxValue, StDevPA, "Statistical");
            ...
            ce.RegisterFunction("VAR", 1, int.MaxValue, Var, "Statistical");
            ce.RegisterFunction("VARA", 1, int.MaxValue, VarA, "Statistical");
            ce.RegisterFunction("VARP", 1, int.MaxValue, VarP, "Statistical");
            ce.RegisterFunction("VARPA", 1, int.MaxValue, VarPA, "Statistical");
